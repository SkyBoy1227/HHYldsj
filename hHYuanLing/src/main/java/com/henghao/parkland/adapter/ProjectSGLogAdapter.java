...
import com.henghao.parkland.activity.projectmanage.ProjectSGLogDesActivity;
 ...
 * @since [产品/模块版本]
 */
public class ProjectSGLogAdapter extends ArrayAdapter<ProjectSGLogEntity> {
    ...
    public ProjectSGLogAdapter(ActivityFragmentSupport activityFragment, List<ProjectSGLogEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectSGLogEntity entity = getItem(position);
        ...
        holder.tvTitle.setText(entity.getBuilder());
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entity.isChecked()) {
                    ...
                    callBack.removeId(entity.getCid());
                } else {
                    entity.setChecked(true);
                    callBack.addId(entity.getCid());
                }
                callBack.setChecked();
        ...
        if (showCheckBox) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(mActivityFragmentSupport, ProjectSGLogDesActivity.class);
