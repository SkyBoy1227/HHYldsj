...
public class ProjectKGBGAdapter extends ArrayAdapter<ProjectKGBGEntity> {
    ...
    public ProjectKGBGAdapter(ActivityFragmentSupport activityFragment, List<ProjectKGBGEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectKGBGEntity entity = getItem(position);
        ...
        holder.tvTime.setText(entity.getKgTime());
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entity.isChecked()) {
                    ...
                    callBack.removeId(entity.getKid());
                } else {
                    entity.setChecked(true);
                    callBack.addId(entity.getKid());
                }
                callBack.setChecked();
