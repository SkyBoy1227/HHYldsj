...
import com.henghao.parkland.activity.projectmanage.ProjectSpvLogDesActivity;
...
public class ProjectSpvLogAdapter extends ArrayAdapter<ProjectSpvLogEntity> {
    ...
    public ProjectSpvLogAdapter(ActivityFragmentSupport activityFragment, List<ProjectSpvLogEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectSpvLogEntity entity = getItem(position);
        ...
        holder.tvTitle.setText(entity.getSupervisionPosition());
