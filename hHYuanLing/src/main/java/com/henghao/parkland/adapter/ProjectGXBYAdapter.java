...
import com.henghao.parkland.activity.projectmanage.ProjectGXBYDesActivity;
...
public class ProjectGXBYAdapter extends ArrayAdapter<ProjectGXBYEntity> {
    ...
    public ProjectGXBYAdapter(ActivityFragmentSupport activityFragment, List<ProjectGXBYEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectGXBYEntity entity = getItem(position);
        ...
        holder.tvName.setText(getItem(position).getGxName());
        holder.tvTitle.setText(getItem(position).getGxProcedure());
        holder.tvTime.setText(getItem(position).getGxTime());
