...
import com.henghao.parkland.activity.projectmanage.ProjectSBDataDesActivity;
...
public class ProjectSBDataAdapter extends ArrayAdapter<ProjectSBDataEntity> {
    ...
    public ProjectSBDataAdapter(ActivityFragmentSupport activityFragment, List<ProjectSBDataEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectSBDataEntity entity = getItem(position);
        ...
        holder.tvTitle.setText(entity.getSbName());
        holder.tvTime.setText(entity.getSbSpec());
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entity.isChecked()) {
                    ...
                    callBack.removeId(entity.getEid());
                } else {
                    entity.setChecked(true);
                    callBack.addId(entity.getEid());
                }
                callBack.setChecked();
