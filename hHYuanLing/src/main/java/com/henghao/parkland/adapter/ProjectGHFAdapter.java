...
import com.henghao.parkland.activity.projectmanage.ProjectGHFDesActivity;
...
public class ProjectGHFAdapter extends ArrayAdapter<ProjectGHFEntity> {
    ...
    public ProjectGHFAdapter(ActivityFragmentSupport activityFragment, List<ProjectGHFEntity> mList, MyCallBack callBack) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ProjectGHFEntity entity = getItem(position);
        ...
        holder.tvTitle.setText(entity.getEpName());
        holder.tvTime.setText(entity.getEpDate());
    ...
    private void viewClick(ViewHolder holder, View convertView, final int position) {
        final ProjectGHFEntity entity = getItem(position);
        if (showCheckBox) {
