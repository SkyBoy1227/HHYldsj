            ...
            public void onClick(View v) {
                ...
                switch (position) {
                    case 0:
                        ...
                        intent.putExtra("url", Requester.getRequestHZURL(ProtocolUrl.ADD_WORK_TASK) + mActivityFragmentSupport.getLoginUserName());
                    ...
                    case 1:
                        ...
                        intent.putExtra("url", Requester.getRequestHZURL(ProtocolUrl.ADD_WORK_ARRANGE) + mActivityFragmentSupport.getLoginUserName());
                        intent.setClass(mActivityFragmentSupport, WebviewActivity.class);
                        mActivityFragmentSupport.startActivity(intent);
                        break;
                    case 2:
                        ...
                        intent.putExtra("url", Requester.getRequestHZURL(ProtocolUrl.ADD_MY_PLAN) + mActivityFragmentSupport.getLoginUserName());
                        intent.setClass(mActivityFragmentSupport, WebviewActivity.class);
                        mActivityFragmentSupport.startActivity(intent);
                        break;
                }
