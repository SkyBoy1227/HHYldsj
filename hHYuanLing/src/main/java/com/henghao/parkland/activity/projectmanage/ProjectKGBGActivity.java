 ...
 * 项目管理 -- 开工报告
 */
public class ProjectKGBGActivity extends ActivityFragmentSupport implements MyCallBack {


    @InjectView(R.id.lv_projectkgbg)
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectKGBGAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectKGBGEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_KGREPORT).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
