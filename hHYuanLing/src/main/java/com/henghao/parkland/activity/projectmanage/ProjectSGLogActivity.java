...
public class ProjectSGLogActivity extends ActivityFragmentSupport implements MyCallBack {
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectSGLogAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectSGLogEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_CONSTURCTIONLOG).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
