 ...
 * 项目管理 -- 工序报验
 */
public class ProjectGXBYActivity extends ActivityFragmentSupport implements MyCallBack {


    @InjectView(R.id.lv_projectgxby)
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectGXBYAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectGXBYEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_CHECKOUT).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
