...
public class ProjectSGSafeLogActivity extends ActivityFragmentSupport implements MyCallBack {
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectSGSafeLogAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectSGSafeLogEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_CONSTURCTIONSAFELOG).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
