 ...
 * 项目管理 -- 项目结算
 */
public class ProjectSettlementActivity extends ActivityFragmentSupport implements MyCallBack {
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectSettlementAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectSettlementEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_SETTLEMENT).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
            ...
            public void onFailure(Request request, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(ProjectSettlementActivity.this, "网络访问错误！", Toast.LENGTH_SHORT).show();
                    }
                });
            }
