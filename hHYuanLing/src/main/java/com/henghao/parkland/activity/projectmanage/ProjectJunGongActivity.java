...
public class ProjectJunGongActivity extends ActivityFragmentSupport implements MyCallBack {
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectJunGongAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectJunGongEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_FINALACCEPTANCE).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
