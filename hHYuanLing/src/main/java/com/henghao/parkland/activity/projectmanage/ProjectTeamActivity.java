 ...
 * 项目管理 -- 施工人员
 */
public class ProjectTeamActivity extends ActivityFragmentSupport implements MyCallBack {


    @InjectView(R.id.lv_projectteam)
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectTeamAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectTeamEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        ...
        Request request = builder.post(requestBody).url(ProtocolUrl.ROOT_URL + ProtocolUrl.DELETE_SGPERSONNEL).build();
        mActivityFragmentView.viewLoading(View.VISIBLE);
