 ...
 * 项目管理 -- 变更管理
 */
public class ProjectBGManageActivity extends ActivityFragmentSupport implements MyCallBack {
    ...
    private static final String TAG = "ProjectBGManageActivity";
    ...
    public void initData() {
        ...
        data = new ArrayList<>();
        mAdapter = new ProjectBGManageAdapter(this, data, this);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkBox.isChecked()) {
                    itemID.clear();
                    for (ProjectBGManageEntity entity : data) {
    ...
    private void deleteInfo(List<DeleteEntity> entity) {
        deleteCall = Requester.changeManageDeleteInfo(entity, new DefaultCallback() {
            @Override
